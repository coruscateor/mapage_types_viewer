...
#[derive(Debug)]
pub struct AllOrNotTypeInstanceSubContents<P>
    where P: 'static
{
...
impl<P> AllOrNotTypeInstanceSubContents<P>
    where P: 'static
{
    ...
    pub fn new() -> Rc<Self>
    {
        ...
        this.type_instance_strs_dropdown.connect_selected_item_notify(clone!( #[weak] this, move |type_instance_strs_dropdown|
        {
    ...
    pub fn all_or_not_type_instance_result(&self) -> Result<AllOrNot<TypeInstance>, String>
    {
    ...
    */
    ...
    fn try_set_type_instance(&self, variant_str: &str)
    {
        ...
        if variant_str == "*"
        {
            ...
            self.all_or_not_type_instance_result.set(Ok(AllOrNot::All));
                ...
                Ok(res) =>
                {
                    ...
                    match the_res
                    {
                        ...
                        Ok(res) =>
                        {
                            ...
                            self.all_or_not_type_instance_result.set(Ok(AllOrNot::NotAll(res)));
                        ...
                        Err(error_message) =>
                        {
                            ...
                            self.all_or_not_type_instance_result.set(Err(error_message));

                            self.all_or_not_type_instance_result.borrow(|store|
                            {
